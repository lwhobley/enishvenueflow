...
export const NEW_HIRES_ROSTER: Hire[] = [
  ...
  },
  {
    ...
    positions: ["bartender", "server", "host", "hookah tech"],
    hireDate: "2026-04-29",
    hourlyRate: null,
  },
  {
    fullName: "Devin M. Lane",
    email: "devinlane79@yahoo.com",
    phone: "281-513-7886",
    dateOfBirth: "1998-08-29",
    address: "22862 Ephesus Ave, Tomball, TX 77377",
    positions: ["barback"],
    hireDate: "2026-04-29",
    hourlyRate: null,
  },
  {
    fullName: "Patrick J. Devaughn",
    email: "patrickdevaughn13@gmail.com",
    phone: "346-524-4632",
    dateOfBirth: "2002-02-05",
    address: "8033 Parnell St, Houston, TX 77051",
    positions: ["hookah tech"],
    hireDate: "2026-04-29",
    hourlyRate: 15,
  },
];
